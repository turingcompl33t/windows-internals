// use_threadpool_engine.cpp
//
// Refactor of bulk copy application to use threadpool_copy_engine class implementation.
//
// Build
//  cl /EHsc /nologo /std:c++17 /W4 /I %WIN_WORKSPACE%\_Deps\WDL\include use_threadpool_engine.cpp

#include <chrono>
#include <optional>
#include <iostream>

#include "threadpool_copy_engine.hpp"
...
int main(int argc, char* argv[])
{
    ...
    auto engine = threadpool_copy_engine{threadcount};
